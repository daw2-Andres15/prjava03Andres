...
public class Prjava03Andres extends Frame 
   ...
   public Prjava03Andres () { 
      ...
      setTitle("nova finestra prjava03Andres");  // "this" Frame sets title 
   ...
   public static void main(String[] args) { 
      new Prjava03Andres();  // Let the construct do the job 
   } 
